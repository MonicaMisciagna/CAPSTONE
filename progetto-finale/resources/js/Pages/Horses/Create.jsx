...
const Create = ({ auth }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post('/DashboardAdmin/horses/store', data);
    };

    return (
        <AuthenticatedLayout user={auth.user}>
            <Head title="Crea Cavallo" />
            <div className="py-12">
                    ...
                    <div className="bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-4">
                                    <label htmlFor="sex" className="block text-gray-700 mb-2">Sesso</label>
                                    <select
                                        id="sex"
                                        name="sex"
                                        className="w-full border rounded-md py-2 px-3 focus:outline-none focus:ring focus:border-indigo-300"
                                    ...
                                    >
                                        ...
                                        <option value="castrone">Castrone</option>
                                    </select>
